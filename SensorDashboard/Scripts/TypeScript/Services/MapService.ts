...
export class MapService {
    currentMap: any = null;
    currentflightPath: any = null;
    traceIsDisplayed: boolean = false;
     ...
     * @param zoom Zoom 
     */
    init(cetered: Point = new Point(35.0163, 48.4671), zoom: number = 12) {
